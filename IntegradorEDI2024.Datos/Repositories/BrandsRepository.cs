...
namespace IntegradorEDI2024.Datos.Repositories
{
    public class BrandsRepository : IBrandsRepository
    {
        ...
        public BrandsRepository(MiDbContext context)
        {
            _context = context;
        }
        ...
        public Brand? GetBrandById(int BrandId) => _context.Brands.SingleOrDefault(br => br.BrandId == BrandId);

        public Brand? GetBrandByName(string BrandName) => _context.Brands.SingleOrDefault(br => br.BrandName == BrandName);

        public List<Brand> GetList() => _context.Brands.ToList();
